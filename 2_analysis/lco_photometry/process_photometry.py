"""Script to run all jobs in this folder submodule"""
    ...
    for index, script in enumerate(script_list):
        if args[index]=='y':
            ...
            try:
                ...
                result = subprocess.run([sys.executable, script], check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
